<template>
    ...
    >
          <div style="width: 100%;">
            ...
            <div style="display: flex; justify-content: space-between; width: 100%; padding: 0 28px; max-width:768px; margin: 0 auto;">
...
export default {
  ...
  computed: {
    ...
    balance() {
      ...
      return this.$store.getters['coinIndex/all']().find(x => x.symbol === this.symbol).user_quantity;
    }
  },
  mounted() {
