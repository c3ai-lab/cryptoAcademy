                ...
                <div class="mt-4">
                  ...
                  <div>
                    <div class="btn-group btn-group-example mb-3" role="group">
                      <b-button variant="outline-primary" class="w-sm">Left</b-button>
                      <b-button variant="outline-primary" class="w-sm">Middle</b-button>
                      <b-button variant="outline-primary" class="w-sm">Right</b-button>
                    </div>
